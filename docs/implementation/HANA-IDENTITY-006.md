...
- HTTPS خارج از Development اجباری است؛ روی Development فقط اتصال loopback HTTP پذیرفته می‌شود. تا زمان استقرار، termination TLS و پروکسی‌های مورداعتماد و قواعد real-client-IP باید بررسی شوند.
