...
در چرخه پایان **هر روز کاری همه فروشگاه‌ها** طبق [ADR-038](../adr/ADR-038-ALL-SELLERS-SETTLED-END-OF-EACH-WORKDAY.md)، `businessDate`, `settlementCycleId`, `cycleCutoffAt`, `policyVersion` و وضعیت `PAYOUT_SUBMITTED | PAYOUT_UNKNOWN | PAID` باید قابل پیگیری و تطبیق باشند. hold فاکتور A نباید مانع payout فاکتور B همان فروشنده شود. طبق [ADR-039](../adr/ADR-039-THURSDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md)، [ADR-040](../adr/ADR-040-FRIDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) و [ADR-041](../adr/ADR-041-SETTLE-ALL-SELLERS-ON-OFFICIAL-HOLIDAYS.md)، **تمام روزهای تقویمی شامل پنجشنبه، جمعه و تعطیلات رسمی** روز چرخه batch هستند؛ طبق [ADR-042](../adr/ADR-042-AUTOMATIC-SELLER-SETTLEMENT-AT-MIDNIGHT-BANK-CYCLE-DEPENDENT.md)، batch به‌طور خودکار هر شب **`00:00` نیمه‌شب** برای `businessDate` روز پایان‌یافته آغاز می‌شود؛ منطقه زمانی مرجع طبق [ADR-043](../adr/ADR-043-MIDNIGHT-SETTLEMENT-IN-IRAN-TIMEZONE.md) **`Asia/Tehran`** است، `businessDate` روز محلی ایران پایان‌یافته است و زمان وصول واقعی بانک هنوز باید در قرارداد اجرایی تعیین شود.
