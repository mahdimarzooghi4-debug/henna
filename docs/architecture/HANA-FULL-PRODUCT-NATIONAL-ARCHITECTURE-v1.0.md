...
**مرز لجستیک:** طبق [ADR-004](../adr/ADR-004-HANA-LOGISTICS-INDEPENDENT-INTEGRATION.md)، لجستیک حنا یک کسب‌وکار/سامانه عملیاتی مستقل و متصل از طریق API است؛ بازارگاه مالک سفارش و لجستیک مالک مأموریت حمل است. انحصاری‌بودن لجستیک حنا یا مجازبودن تحویل فروشنده/حضوری هنوز تصمیم‌گیری نشده است.
...
| D02 — بخشی تصویب‌شده | انتخاب فروشنده با سبد کامل یا ناقص و تعیین تکلیف اقلام تأمین‌نشده به اختیار مشتری است؛ [ADR-002](../adr/ADR-002-CUSTOMER-CHOICE-PARTIAL-BASKET.md) و [ADR-003](../adr/ADR-003-CUSTOMER-CONTROL-UNFULFILLED-CART-ITEMS.md). روش دقیق رتبه‌بندی، محدوده، هزینه ارسال، pick-up و ظرفیت خدمت باز است؛ اصل استقلال کسب‌وکار لجستیک و اتصال API طبق [ADR-004](../adr/ADR-004-HANA-LOGISTICS-INDEPENDENT-INTEGRATION.md) تصویب شده است | Geo/Quote/UX |
