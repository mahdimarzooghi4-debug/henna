...
| F10 | پرداخت | فقط روش‌های غیرحضوریِ مصوب؛ بدون COD، success/failure/unknown، webhook تکراری، استعلام و reconciliation طبق ADR-009؛ کیف پول نقدیِ قابل استرداد و درخواست عودت بانکی طبق ADR-014 |
