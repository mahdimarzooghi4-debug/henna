...
| کد | تصمیم لازم | اثر |
|---|---|---|
| D01 | مدل نهایی سفارش: یک فروشنده در هر checkout یا چند فروشنده؟ | Cart/Order/Payment/Fulfillment |
...
**پیش از کدنویسی می‌توان اسکلت، UI، mock در dev/stage و قراردادهای اولیه را ساخت؛ اما پیش از freeze دامنه و انتشار عمومی شهر اول، D01–D10 باید به تصمیم امضاشده/ADR با مالک و تاریخ تبدیل شوند.** این سند معماری را کامل می‌کند، ولی سیاست‌های کسب‌وکار را بدون مالک جعل نمی‌کند.
