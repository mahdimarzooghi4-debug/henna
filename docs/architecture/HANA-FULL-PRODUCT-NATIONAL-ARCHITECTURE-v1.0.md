...
| F09 | سفارش/لجستیک | تأیید فروشنده، آماده‌سازی، تحویل یا ارائه خدمت، مشکل، لغو مشتری برای سفارش ارسالی تا پیش از handoff واقعی به هر نوع پیک طبق ADR-011 و ADR-018 و برای سفارش حضوری تا پیش از دریافت واقعی توسط مشتری طبق ADR-012؛ پس از handoff فقط گزارش مشکل طبق ADR-019، بازپرداخت کامل پس از تأیید عدم‌تحویل کل سفارش طبق ADR-020، مرجوعی طبق سیاست |
