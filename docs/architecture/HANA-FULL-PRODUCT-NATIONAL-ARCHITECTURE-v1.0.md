...
| F09 | سفارش/لجستیک | تأیید فروشنده، آماده‌سازی، تحویل یا ارائه خدمت، مشکل، لغو مشتری برای سفارش ارسالی تا پیش از handoff واقعی به هر نوع پیک طبق ADR-011 و ADR-018 و برای سفارش حضوری تا پیش از دریافت واقعی توسط مشتری طبق ADR-012؛ پس از handoff فقط گزارش مشکل طبق ADR-019، بازپرداخت کامل پس از تأیید عدم‌تحویل کل سفارش طبق ADR-020، گزارش عکس کسری/خرابی طبق ADR-021، تأیید پشتیبانی و جمع‌آوری کالای خراب توسط خود فروشگاه بدون پیک لجستیک طبق ADR-023، واریز همان‌موقع جبران خرابی به کیف پول مستقل از جمع‌آوری طبق ADR-024، جمع‌آوری کالای خراب حداکثر ظرف یک ساعت توسط فروشگاه طبق ADR-025 و جریمه مالی تأخیر طبق ADR-026 معادل قیمت واقعی کالای خراب پس از تخفیف در سفارش طبق ADR-027 و ADR-028، مرجوعی طبق سیاست |
