...
| F09 | سفارش/لجستیک | تأیید فروشنده، آماده‌سازی، تحویل یا ارائه خدمت، مشکل، لغو مشتری برای سفارش ارسالی تا پیش از handoff واقعی به هر نوع پیک طبق ADR-011 و ADR-018 و برای سفارش حضوری تا پیش از دریافت واقعی توسط مشتری طبق ADR-012؛ پس از handoff فقط گزارش مشکل طبق ADR-019، مرجوعی طبق سیاست |
...
| F17 | مالی/تسویه | ledger، مبالغ قابل تسویه، کسر یک‌باره و شفاف سهم ارسال فروشنده از تسویه طبق ADR-007، بازپرداخت کامل مشتری برای لغو مجاز طبق ADR-013، قرارداد مصوب و تطبیق |
