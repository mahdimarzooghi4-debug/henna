...
| D02 — بخشی تصویب‌شده | انتخاب فروشنده با سبد کامل یا ناقص به اختیار مشتری است؛ [ADR-002](../adr/ADR-002-CUSTOMER-CHOICE-PARTIAL-BASKET.md). روش دقیق رتبه‌بندی، محدوده، هزینه ارسال، pick-up و ظرفیت خدمت باز است | Geo/Quote/UX |
