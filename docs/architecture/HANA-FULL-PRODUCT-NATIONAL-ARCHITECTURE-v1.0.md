...
| D03 — بخشی تصویب‌شده | سهم ارسال فروشنده از تسویه داخل حنا کسر می‌شود؛ [ADR-007](../adr/ADR-007-SELLER-DELIVERY-SHARE-DEDUCTED-AT-SETTLEMENT.md). پرداخت در محل، زمان تسویه و سیاست لغو/مرجوعی/جبران باز است | Finance/Operations |
