...
**لغو سفارش توسط مشتری:** طبق [ADR-010](../adr/ADR-010-CUSTOMER-CANCEL-BEFORE-PREPARATION.md)، مشتری می‌تواند سفارش سوپرمارکتی پرداخت‌شده را تا پیش از شروع واقعی آماده‌سازی توسط فروشنده از داخل حنا لغو کند؛ تأیید فروشنده لزوماً شروع آماده‌سازی نیست. تعارض هم‌زمان لغو و شروع آماده‌سازی باید اتمیک حل شود. قواعد لغو بعد از شروع آماده‌سازی و جزئیات بازپرداخت هنوز باز هستند.
...
| F09 | سفارش/لجستیک | تأیید فروشنده، آماده‌سازی، تحویل یا ارائه خدمت، مشکل، لغو مشتری پیش از شروع آماده‌سازی طبق ADR-010، مرجوعی طبق سیاست |
