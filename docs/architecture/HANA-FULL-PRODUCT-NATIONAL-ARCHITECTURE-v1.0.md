...
| F17 | مالی/تسویه | ledger، مبالغ قابل تسویه، توقف تسویه همان فاکتور در پرونده به‌موقعِ کسری/خرابی تا نتیجه پشتیبانی طبق ADR-032، کسر یک‌باره و شفاف سهم ارسال فروشنده از تسویه طبق ADR-007، بازپرداخت کامل مشتری برای لغو مجاز طبق ADR-013 یا تأیید نرسیدن کل سفارش طبق ADR-020، قرارداد مصوب و تطبیق |
