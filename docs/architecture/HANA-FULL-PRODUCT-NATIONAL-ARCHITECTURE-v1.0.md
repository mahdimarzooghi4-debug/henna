...
| D02 — بخشی تصویب‌شده | انتخاب فروشنده با سبد کامل یا ناقص و تعیین تکلیف اقلام تأمین‌نشده به اختیار مشتری است؛ [ADR-002](../adr/ADR-002-CUSTOMER-CHOICE-PARTIAL-BASKET.md) و [ADR-003](../adr/ADR-003-CUSTOMER-CONTROL-UNFULFILLED-CART-ITEMS.md). روش دقیق رتبه‌بندی، محدوده، هزینه ارسال و ظرفیت خدمت باز است؛ اصل استقلال لجستیک در [ADR-004](../adr/ADR-004-HANA-LOGISTICS-INDEPENDENT-INTEGRATION.md) و انتخاب مراجعه حضوری با مشتری/تعیین مجری ارسال با لجستیک در [ADR-005](../adr/ADR-005-PICKUP-CUSTOMER-DELIVERY-ASSIGNMENT-LOGISTICS.md) تصویب شده است | Geo/Quote/UX |
