...
| F09 | سفارش/لجستیک | تأیید فروشنده، آماده‌سازی، تحویل یا ارائه خدمت، مشکل، لغو مشتری برای سفارش ارسالی تا پیش از handoff واقعی به پیک طبق ADR-011 و برای سفارش حضوری تا پیش از دریافت واقعی توسط مشتری طبق ADR-012، مرجوعی طبق سیاست |
