...
| پنل ادمین وب | کاربران/نقش، فروشندگان/درخواست، کاتالوگ و محتوا، دسته‌بندی، سفارش و رسیدگی، اعتبار/طرح، سازمان/منبع داده، **بخش لجستیک متصل به سرویس بیرونی (طرح صفحه در انتظار افزودن به Figma طبق ADR-046)**، مالی، پشتیبانی، اعلان، گزارش و audit |
...
### ۴.۱. قرارداد فنی جریان گزارش و مالیِ اختلاف سفارش

جریان کسری و خرابیِ تصویب‌شده در ADR-019 تا ADR-037 اکنون از حالت صرفاً شرح تصمیم محصول به **طرح اجرا** تفکیک شده است: [معماری جزئی و مرز تراکنش‌ها](HANA-INCIDENT-REFUND-SETTLEMENT-TECHNICAL-DESIGN-v0.1.md)، [قرارداد جزئی API و رویدادها](../api/HANA-INCIDENT-SETTLEMENT-API-CONTRACT-v0.1.md)، [مدل داده و قیود پیشنهادی](HANA-DOMAIN-ERD-draft.md) و [ماتریس آزمون پذیرش](../testing/HANA-INCIDENT-SETTLEMENT-ACCEPTANCE-MATRIX-v0.1.md). این‌ها **سند طراحی هستند، نه گزارش ساخت یا تست اجراشده**.

**مرز اصلی صحت مالی:** ثبت به‌موقع پرونده و hold تسویه باید در برابر payout اتمیک باشند؛ تأیید خرابی نیازمند بازپس‌گیری نباید بین آزادسازی hold پشتیبانی و ثبت hold یک‌ساعته فروشگاه، شکاف پرداخت ایجاد کند. پرداخت refund مصوب مشتری مستقل از وصول جریمه و بازپس‌گیری است؛ غیبت احرازشده مشتری با تماس اولیه و مراجعه به‌موقع فروشگاه، بدون `sellerCollectedAt` صوری، تعهد مراجعه مجدد و جریمه را پایان می‌دهد. روش اثبات حضور و موارد مالی هنوز باز صریحاً در گیت انتشار باقی می‌مانند.
...
**مرز درآمد و اشخاص کسب‌وکار (ADR-044):** [درآمد بازارگاه حنا کارمزد **ثابت به‌ازای هر فاکتور** است](../adr/ADR-044-SEPARATE-HANA-FIXED-INVOICE-FEE-FROM-LOGISTICS-COURIER-REVENUE.md)، نه کمیسیون درصدی از ارزش فروش. «۱۰٪ از پیک» که مالک محصول ذکر کرده، درآمد **کسب‌وکار مستقل لجستیک** است و در درآمد بازارگاه حنا ثبت یا با آن تجمیع نشود. این جدایی مالی/کسب‌وکار با تبادل داده و عملیات سفارش/ارسال از طریق رابط مصوب ADR-004 منافات ندارد. کسر سهم حمل فروشنده در تسویه سفارش طبق ADR-007، ذاتاً کارمزد بازارگاه نیست؛ دفترکل و گزارش‌ها باید کارمزد ثابت حنا، هزینه حمل و سهم کسب‌وکار لجستیک را جدا کنند. مبلغ دقیق کارمزد ثابت و مبنای دقیق ۱۰٪ از این اظهارنظر تعیین نشده است.

**مرز لجستیک و صفحه ادمین:** طبق [ADR-046](../adr/ADR-046-ADMIN-LOGISTICS-SECTION-EXTERNAL-SERVICE-FIGMA-DEFERRED.md)، **بخش لجستیک در پنل ادمین حنا هست**؛ خدمت/سامانه عملیاتی لجستیک از بیرون گرفته می‌شود و صفحه‌های این بخش هنگام طراحی/ساخت آن به فیگما اضافه خواهند شد. صفحه ادمین صرفاً UI مدیریت/مشاهده دامنه سفارش و اتصال بیرونی با دسترسی مصوب است، نه پنل عملیاتی ناوگانِ بومی بازارگاه. طبق [ADR-004](../adr/ADR-004-HANA-LOGISTICS-INDEPENDENT-INTEGRATION.md)، لجستیک حنا یک کسب‌وکار/سامانه عملیاتی مستقل و متصل از طریق API است؛ بازارگاه مالک سفارش و لجستیک مالک مأموریت حمل است. طبق [ADR-005](../adr/ADR-005-PICKUP-CUSTOMER-DELIVERY-ASSIGNMENT-LOGISTICS.md)، دریافت حضوریِ قابل ارائه به انتخاب مشتری است و در حالت ارسال، لجستیک حنا تعیین می‌کند مجری فروشنده باشد یا شبکه لجستیک؛ این انتخاب اجرایی را مشتری انجام نمی‌دهد. طبق [ADR-006](../adr/ADR-006-LOGISTICS-DELIVERY-FEE-SPLIT.md)، لجستیک مرجع تعیین مبلغ کل ارسال است؛ در حالت معمول سهم خریدار و فروشنده از آن نصف‌نصف است. طبق [ADR-007](../adr/ADR-007-SELLER-DELIVERY-SHARE-DEDUCTED-AT-SETTLEMENT.md) سهم فروشنده از تسویه او در حنا کسر می‌شود، نه از طریق پرداخت جداگانه. تعرفه‌ها، زمان کسر و استثناها هنوز نیازمند تصویب قرارداد مالی‌اند.
...
**لغو سفارش توسط مشتری:** طبق [ADR-011](../adr/ADR-011-CANCEL-UNTIL-HANDOFF-TO-COURIER.md) که [ADR-010](../adr/ADR-010-CUSTOMER-CANCEL-BEFORE-PREPARATION.md) را برای سفارش ارسالی گسترش می‌دهد، مشتری می‌تواند سفارش سوپرمارکتی پرداخت‌شده را حتی پس از شروع آماده‌سازی، **تا قبل از تحویل واقعی به پیک** از داخل حنا لغو کند. صرف تخصیص پیک یا آماده‌بودن سفارش مانع نیست. رقابت لغو/تحویل به پیک باید اتمیک حل شود. طبق [ADR-012](../adr/ADR-012-PICKUP-CANCEL-UNTIL-COLLECTION.md)، سفارش حضوری تا پیش از دریافت واقعی توسط مشتری قابل لغو است. طبق [ADR-013](../adr/ADR-013-FULL-BUYER-REFUND-ON-VALID-CANCELLATION.md)، لغو مجاز با بازپرداخت کامل مبلغ واقعاً پرداخت‌شده مشتری، شامل سهم او از ارسال و بدون جریمه است؛ طبق [ADR-014](../adr/ADR-014-WALLET-REFUND-OPTIONAL-CASHOUT.md)، سهم نقدی بازپرداخت ابتدا به کیف پول قابل‌استرداد حنا می‌رود و عودت بانکی با درخواست مشتری انجام می‌شود؛ اعتبار حمایتی نقد نمی‌شود. طبق [ADR-015](../adr/ADR-015-WITHDRAWAL-TO-OWN-VERIFIED-IBAN.md)، عودت بانکی فقط به شبای متعلق به خود مشتری است؛ طبق [ADR-016](../adr/ADR-016-FEE-FREE-FULL-WALLET-WITHDRAWAL.md) کارمزد عودت مشتری صفر است و کل مبلغ درخواستیِ تأییدشده باید به شبای او برسد؛ طبق [ADR-017](../adr/ADR-017-WALLET-WITHDRAWAL-WITHIN-72-HOURS.md)، مهلت عودت بانکی حداکثر ۷۲ ساعت **از ثبت درخواست مشتری** است؛ روش احراز تعلق شبا و روش ثبت معتبر handoff در سامانه لجستیک هنوز نیازمند قرارداد اجرایی‌اند؛ طبق [ADR-018](../adr/ADR-018-SAME-CANCEL-CUTOFF-FOR-ALL-COURIERS.md) مرز لغو برای پیک شبکه حنا و فروشنده‌ای که مجری حمل است یکسان است؛ طبق [ADR-019](../adr/ADR-019-NO-CANCEL-AFTER-COURIER-HANDOFF.md) پس از handoff درخواست لغو مجاز نیست و مشتری از مسیر گزارش مشکل سفارش اقدام می‌کند، بدون لغو/استرداد صرفاً با ثبت گزارش؛ طبق [ADR-020](../adr/ADR-020-FULL-REFUND-ON-CONFIRMED-NONDELIVERY.md) در صورت تأیید نرسیدن کل سفارش، تمام مبلغ پرداختی مشتری شامل سهم ارسال با حفظ منشأ وجوه بازگردانده می‌شود. طبق [ADR-021](../adr/ADR-021-ITEM-SHORTAGE-DAMAGE-PHOTO-SELLER-RESOLUTION.md)، کسری یا خرابی اقلام با عکس مشتری و بررسی پشتیبانی حنا ثبت می‌شود و در صورت تأیید برای هماهنگی بازپس‌گیری کالای خراب توسط فروشگاه یا جبران وجه مرتبط اقدام می‌شود؛ طبق [ADR-022](../adr/ADR-022-ITEM-ISSUE-REFUND-TO-WALLET-OPTIONAL-WITHDRAWAL.md) سهم نقدی جبران کسری/خرابی ابتدا به کیف پول حنا می‌رود و عودت بانکی فقط در صورت درخواست مشتری انجام می‌شود؛ طبق [ADR-023](../adr/ADR-023-SUPPORT-APPROVAL-SELLER-COLLECTS-DAMAGED-GOODS.md)، گزارش عکس ابتدا به پشتیبانی حنا می‌رود و پس از تأیید با فروشگاه هماهنگ می‌شود؛ بازپس‌گیری فیزیکی کالای خراب به عهده خود فروشگاه است و پیک لجستیک حنا برای این مرجوعی مجاز نیست. طبق [ADR-024](../adr/ADR-024-IMMEDIATE-WALLET-REFUND-ON-APPROVED-DAMAGE.md)، جبران وجهِ تأییدشده خرابی همان موقع به کیف پول منظور می‌شود و دریافت فیزیکی کالای خراب پیش‌نیاز نیست؛ طبق [ADR-025](../adr/ADR-025-SELLER-COLLECTS-DAMAGED-RETURN-WITHIN-ONE-HOUR.md) فروشگاه حداکثر یک ساعت برای بازپس‌گیری واقعی کالای خراب فرصت دارد؛ شمارش این ساعت از ثبت تأیید خرابی توسط پشتیبانی حنا شروع می‌شود؛ طبق [ADR-026](../adr/ADR-026-SELLER-PENALTY-FOR-LATE-DAMAGED-RETURN.md)، تأخیر فروشگاه مشمول جریمه مالی است؛ طبق [ADR-027](../adr/ADR-027-LATE-DAMAGED-RETURN-PENALTY-EQUALS-ITEM-PRICE.md) جریمه برابر قیمت همان کالای خراب است؛ طبق [ADR-028](../adr/ADR-028-PENALTY-USES-ACTUAL-ORDER-ITEM-PRICE.md) قیمت واقعی نهایی همان قلم در سفارش پس از تخفیف مبنای جریمه است؛ طبق [ADR-029](../adr/ADR-029-DEDUCT-LATE-RETURN-PENALTY-FROM-SELLER-SETTLEMENT.md) جریمه از وجه فاکتور که تا پیش از اجرای تسویه در حناست، در تسویه همان فروشگاه کسر می‌شود؛ طبق [ADR-030](../adr/ADR-030-CUSTOMER-DAMAGE-REPORT-WITHIN-ONE-HOUR-OF-RECEIPT.md) مشتری برای ثبت خرابی و طبق [ADR-031](../adr/ADR-031-MISSING-ITEM-REPORT-WITHIN-ONE-HOUR-OF-RECEIPT.md) برای ثبت کسری اقلام حداکثر یک ساعت از دریافت واقعی سفارش مهلت دارد. تأیید پشتیبانی و یک ساعت جمع‌آوری فروشگاه ساعت‌های مستقلی دارند؛ طبق [ADR-032](../adr/ADR-032-HOLD-INVOICE-SETTLEMENT-UNTIL-SUPPORT-RESOLVES-ITEM-INCIDENT.md)، گزارش به‌موقع کسری/خرابی، تسویه همان فاکتور را تا اعلام نتیجه پشتیبانی متوقف می‌کند؛ طبق [ADR-033](../adr/ADR-033-HOLD-DAMAGED-INVOICE-THROUGH-SELLER-COLLECTION-SLA.md)، در خرابی تأییدشده نیازمند بازپس‌گیری، توقف تسویه تا تعیین نتیجه مهلت یک‌ساعته فروشگاه و اعمال جریمه احتمالی ادامه دارد؛ طبق [ADR-034](../adr/ADR-034-RELEASE-SETTLEMENT-HOLD-ON-EARLY-DAMAGED-RETURN-COLLECTION.md)، دریافت واقعی معتبر در مهلت موجب رفع همان‌موقع hold جمع‌آوری می‌شود؛ بازگشت به روال عادی تسویه مشروط به نبود مانع دیگر است و به معنی پرداخت فوری بانکی نیست؛ طبق [ADR-035](../adr/ADR-035-CALL-CUSTOMER-FIRST-EXEMPT-VERIFIED-CUSTOMER-UNAVAILABILITY.md)، فروشگاه پیش از جمع‌آوری باید به مشتری تماس بگیرد و طبق [ADR-036](../adr/ADR-036-SELLER-MUST-VISIT-CUSTOMER-DOOR-AFTER-FIRST-CALL.md) **در همان یک ساعت به درِ نشانی مشتری مراجعه کند**؛ تماس بی‌پاسخ به‌تنهایی کافی نیست و عدم دریافت ناشی از عدم دسترسی احرازشده مشتری پس از این اقدامات، با بررسی پشتیبانی، جریمه فروشگاه ندارد و hold پرونده بدون ثبت دریافت صوری رفع می‌شود؛ طبق [ADR-037](../adr/ADR-037-NO-SECOND-SELLER-VISIT-AFTER-VERIFIED-CUSTOMER-UNAVAILABILITY.md) فروشگاه حتی پس از در دسترس‌شدن بعدی مشتری الزام مراجعه مجدد برای همان پرونده ندارد.
...
| F09 | سفارش/لجستیک | تأیید فروشنده، آماده‌سازی، تحویل یا ارائه خدمت، مشکل، لغو مشتری برای سفارش ارسالی تا پیش از handoff واقعی به هر نوع پیک طبق ADR-011 و ADR-018 و برای سفارش حضوری تا پیش از دریافت واقعی توسط مشتری طبق ADR-012؛ پس از handoff فقط گزارش مشکل طبق ADR-019، بازپرداخت کامل پس از تأیید عدم‌تحویل کل سفارش طبق ADR-020، گزارش عکس کسری/خرابی طبق ADR-021، تأیید پشتیبانی و جمع‌آوری کالای خراب توسط خود فروشگاه بدون پیک لجستیک طبق ADR-023، واریز همان‌موقع جبران خرابی به کیف پول مستقل از جمع‌آوری طبق ADR-024، جمع‌آوری کالای خراب حداکثر ظرف یک ساعت توسط فروشگاه طبق ADR-025 و جریمه مالی تأخیر طبق ADR-026 معادل قیمت واقعی کالای خراب پس از تخفیف در سفارش طبق ADR-027 و ADR-028 و کسر از تسویه فروشگاه طبق ADR-029، ثبت خرابی و کسری توسط مشتری تا یک ساعت از دریافت واقعی طبق ADR-030 و ADR-031، توقف تسویه فاکتور دارای گزارش به‌موقع تا نتیجه پشتیبانی طبق ADR-032 و در خرابی تأییدشده با بازپس‌گیری تا تعیین نتیجه ساعت یک‌ساعته فروشگاه طبق ADR-033، با آزادسازی همان‌موقع hold در دریافت واقعی به‌موقع طبق ADR-034 و تماس اولیه فروشگاه/معافیت عدم دسترسی احرازشده مشتری طبق ADR-035، مراجعه الزامی به درِ مشتری در مهلت طبق ADR-036 و نبود الزام مراجعه مجدد پس از احراز عدم دسترسی مشتری طبق ADR-037، مرجوعی طبق سیاست |
...
| F15 | ادمین | همان داده معتبر، ثبت تصمیم با دلیل/audit، مدیریت محتوا/دسترسی/سازمان و رسیدگی؛ **بخش لجستیکِ متصل به سرویس بیرونی طبق ADR-046، صفحه‌ها در انتظار الحاق به Figma** |
| F16 | سازمان | طرح، افراد، import/API، تطبیق، تخصیص مبتنی بر مدل، مصرف و گزارش scoped |
| F17 | مالی/تسویه | ledger، چرخه تسویه خودکار هر شب **۰۰:۰۰ به وقت ایران (`Asia/Tehran`)** برای همه فروشگاه‌های دارای مبلغ مجاز طبق [ADR-043](../adr/ADR-043-MIDNIGHT-SETTLEMENT-IN-IRAN-TIMEZONE.md) و [ADR-042](../adr/ADR-042-AUTOMATIC-SELLER-SETTLEMENT-AT-MIDNIGHT-BANK-CYCLE-DEPENDENT.md)، با احتساب پنجشنبه، جمعه و تعطیلات رسمی طبق ADR-039 تا ADR-041 و وصول نهایی بر اساس چرخه بانک، مبالغ قابل تسویه، توقف تسویه همان فاکتور در پرونده به‌موقعِ کسری/خرابی تا نتیجه پشتیبانی طبق ADR-032 و در خرابی تأییدشده با بازپس‌گیری تا تعیین نتیجه یک ساعت فروشگاه و جریمه احتمالی طبق ADR-033، رفع همان‌موقع hold در دریافت معتبر به‌موقع طبق ADR-034 و رفع hold بدون جریمه با تأیید عدم دسترسی مشتری پس از تماس و مراجعه به‌موقع توسط پشتیبانی طبق ADR-035 و ADR-036 و بدون اجبار مراجعه مجدد طبق ADR-037، کسر یک‌باره و شفاف سهم ارسال فروشنده از تسویه طبق ADR-007، بازپرداخت کامل مشتری برای لغو مجاز طبق ADR-013 یا تأیید نرسیدن کل سفارش طبق ADR-020، قرارداد مصوب و تطبیق |
...
| D03 — بخشی تصویب‌شده | درآمد فروش بازارگاه کارمزد ثابت به‌ازای هر فاکتور طبق [ADR-044](../adr/ADR-044-SEPARATE-HANA-FIXED-INVOICE-FEE-FROM-LOGISTICS-COURIER-REVENUE.md) است؛ ۱۰٪ از پیک متعلق به کسب‌وکار لجستیک و خارج از درآمد حناست؛  سهم ارسال فروشنده از تسویه داخل حنا کسر می‌شود ([ADR-007](../adr/ADR-007-SELLER-DELIVERY-SHARE-DEDUCTED-AT-SETTLEMENT.md))؛ پرداخت در محل وجود ندارد ([ADR-009](../adr/ADR-009-NO-CASH-ON-DELIVERY.md)). چرخه کوتاه **انجام سفارش سوپرمارکتی** طبق [ADR-008](../adr/ADR-008-GROCERY-ONE-DAY-FULFILLMENT-SETTLEMENT-PENDING.md) معتبر است؛ زمان‌بندی تسویه «یک روز بعد» آن طبق [ADR-038](../adr/ADR-038-ALL-SELLERS-SETTLED-END-OF-EACH-WORKDAY.md) جایگزین شده و تسویه **همه فروشگاه‌ها در پایان هر روز کاری حنا** برای فاکتورهای واجد شرایط انجام می‌شود؛ پنجشنبه طبق [ADR-039](../adr/ADR-039-THURSDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md)، جمعه طبق [ADR-040](../adr/ADR-040-FRIDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) و **تعطیلات رسمی طبق [ADR-041](../adr/ADR-041-SETTLE-ALL-SELLERS-ON-OFFICIAL-HOLIDAYS.md)** همگی در چرخه پایان همان روز تسویه‌اند؛ ساعت خودکار شروع چرخه **۰۰:۰۰ نیمه‌شب** طبق [ADR-042](../adr/ADR-042-AUTOMATIC-SELLER-SETTLEMENT-AT-MIDNIGHT-BANK-CYCLE-DEPENDENT.md) است؛ منطقه زمانی مرجع طبق [ADR-043](../adr/ADR-043-MIDNIGHT-SETTLEMENT-IN-IRAN-TIMEZONE.md) **`Asia/Tehran`** مصوب است؛ زمان وصول واقعی بر اساس چرخه بانک هنوز به قرارداد اجرایی نیاز دارد؛ لغو سفارش ارسالی توسط مشتری تا پیش از تحویل واقعی به پیک طبق [ADR-011](../adr/ADR-011-CANCEL-UNTIL-HANDOFF-TO-COURIER.md) تصویب شده؛ لغو سفارش حضوری تا پیش از دریافت واقعی توسط مشتری طبق [ADR-012](../adr/ADR-012-PICKUP-CANCEL-UNTIL-COLLECTION.md) تصویب شده؛ بازپرداخت کامل مشتری در لغو مجاز طبق [ADR-013](../adr/ADR-013-FULL-BUYER-REFUND-ON-VALID-CANCELLATION.md) و انتقال بخش نقدی آن به کیف پول با عودت بانکیِ درخواستی طبق [ADR-014](../adr/ADR-014-WALLET-REFUND-OPTIONAL-CASHOUT.md) تصویب شده؛ یکسان‌بودن مرز لغو برای هر دو نوع پیک طبق [ADR-018](../adr/ADR-018-SAME-CANCEL-CUTOFF-FOR-ALL-COURIERS.md) تصویب شده؛ طبق [ADR-019](../adr/ADR-019-NO-CANCEL-AFTER-COURIER-HANDOFF.md) لغو/درخواست لغو پس از handoff رد و گزارش مشکل فعال است؛ اصل جبران کامل مشتری برای نرسیدن کل سفارشِ تأییدشده طبق [ADR-020](../adr/ADR-020-FULL-REFUND-ON-CONFIRMED-NONDELIVERY.md) تصویب شده؛ کسری/خرابیِ دارای عکس و رسیدگی فروشگاه طبق [ADR-021](../adr/ADR-021-ITEM-SHORTAGE-DAMAGE-PHOTO-SELLER-RESOLUTION.md) پذیرفته شده و وجه جبران نقدی طبق [ADR-022](../adr/ADR-022-ITEM-ISSUE-REFUND-TO-WALLET-OPTIONAL-WITHDRAWAL.md) ابتدا به کیف پول حنا می‌رود؛ تأیید پشتیبانی و مسئولیت جمع‌آوری خرابی توسط خود فروشگاه بدون لجستیک طبق [ADR-023](../adr/ADR-023-SUPPORT-APPROVAL-SELLER-COLLECTS-DAMAGED-GOODS.md) تصویب شده؛ طبق [ADR-024](../adr/ADR-024-IMMEDIATE-WALLET-REFUND-ON-APPROVED-DAMAGE.md) جبران وجه خرابی همان موقع پس از تأیید پشتیبانی و مستقل از جمع‌آوری به کیف پول می‌رود؛ جمع‌آوری کالای خراب توسط فروشگاه حداکثر ظرف یک ساعت از تأیید پشتیبانی طبق [ADR-025](../adr/ADR-025-SELLER-COLLECTS-DAMAGED-RETURN-WITHIN-ONE-HOUR.md) و اصل جریمه مالی تأخیر فروشگاه طبق [ADR-026](../adr/ADR-026-SELLER-PENALTY-FOR-LATE-DAMAGED-RETURN.md) و معادل‌بودن آن با قیمت کالای خراب طبق [ADR-027](../adr/ADR-027-LATE-DAMAGED-RETURN-PENALTY-EQUALS-ITEM-PRICE.md) تصویب شده‌اند؛ مبنای قیمت واقعی نهایی پس از تخفیف طبق [ADR-028](../adr/ADR-028-PENALTY-USES-ACTUAL-ORDER-ITEM-PRICE.md) و کسر جریمه از تسویه فروشگاه طبق [ADR-029](../adr/ADR-029-DEDUCT-LATE-RETURN-PENALTY-FROM-SELLER-SETTLEMENT.md) تصویب شده‌اند؛ وجه فاکتور تا پیش از تسویه در جریان مالی حناست و کسر جریمه در همان تسویه انجام می‌شود؛ طبق [ADR-030](../adr/ADR-030-CUSTOMER-DAMAGE-REPORT-WITHIN-ONE-HOUR-OF-RECEIPT.md)، مهلت مشتری برای ثبت خرابی و طبق [ADR-031](../adr/ADR-031-MISSING-ITEM-REPORT-WITHIN-ONE-HOUR-OF-RECEIPT.md) برای کسری اقلام، هر دو تا یک ساعت پس از دریافت واقعی سفارش تصویب شدند؛ توقف تسویه فاکتور دارای پرونده به‌موقعِ کسری/خرابی تا نتیجه پشتیبانی طبق [ADR-032](../adr/ADR-032-HOLD-INVOICE-SETTLEMENT-UNTIL-SUPPORT-RESOLVES-ITEM-INCIDENT.md) تصویب شده؛ نگهداری وجه پس از تأیید خرابی با بازپس‌گیری تا تعیین نتیجه مهلت جمع‌آوری و اعمال جریمه احتمالی طبق [ADR-033](../adr/ADR-033-HOLD-DAMAGED-INVOICE-THROUGH-SELLER-COLLECTION-SLA.md) مصوب است؛ آزادسازی همان‌موقع hold در صورت دریافت معتبر و به‌موقع طبق [ADR-034](../adr/ADR-034-RELEASE-SETTLEMENT-HOLD-ON-EARLY-DAMAGED-RETURN-COLLECTION.md) و تماس اولیه و معافیت تأییدشده در عدم دسترسی مشتری طبق [ADR-035](../adr/ADR-035-CALL-CUSTOMER-FIRST-EXEMPT-VERIFIED-CUSTOMER-UNAVAILABILITY.md) و مراجعه الزامی فروشگاه در مهلت به درِ نشانی مشتری طبق [ADR-036](../adr/ADR-036-SELLER-MUST-VISIT-CUSTOMER-DOOR-AFTER-FIRST-CALL.md) و عدم الزام مراجعه مجدد پس از احراز عدم دسترسی مشتری طبق [ADR-037](../adr/ADR-037-NO-SECOND-SELLER-VISIT-AFTER-VERIFIED-CUSTOMER-UNAVAILABILITY.md) مصوب‌اند؛ تکلیف جریمه پس از پرداخت واقعی تسویه همان فاکتور و کسری احتمالی پس از سایر کسورات هنوز باز است؛ جزئیات انتخاب نتیجه، جبران سایر گزارش‌ها، نحوه بررسی عدم‌تحویل، درخواست‌های پس از دریافت حضوری، ضوابط عملیاتی انتقال بانکی و مرجوعی باز هستند؛ مبدأ مهلت عودت زمان ثبت درخواست مشتری است؛ کارمزد عودت مشتری طبق [ADR-016](../adr/ADR-016-FEE-FREE-FULL-WALLET-WITHDRAWAL.md) صفر و واریز تمام مبلغ درخواستی مصوب است؛ مهلت عودت حداکثر ۷۲ ساعت طبق [ADR-017](../adr/ADR-017-WALLET-WITHDRAWAL-WITHIN-72-HOURS.md) تصویب شده | Finance/Operations |
