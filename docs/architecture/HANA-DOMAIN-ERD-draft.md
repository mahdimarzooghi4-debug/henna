...
| Seller Settlement | سهم حمل فروشنده طبق [ADR-007](../adr/ADR-007-SELLER-DELIVERY-SHARE-DEDUCTED-AT-SETTLEMENT.md) به‌صورت کسر مجزای مرتبط با سفارش و فروشنده، فقط یک بار از تسویه حنا؛ جریمه دیرکرد جمع‌آوری خرابی طبق [ADR-029](../adr/ADR-029-DEDUCT-LATE-RETURN-PENALTY-FROM-SELLER-SETTLEMENT.md) به‌صورت ردیف کسر مجزا و یک‌باره از تسویه فروشگاه؛ قواعد کسری تسویه/لغو تا تصویب قرارداد باز |
