...
D01 تصویب شده: یک سفارش = یک فروشنده (ADR-001)؛ اصل انتخاب فروشنده با سبد ناقص در D02 تصویب شده (ADR-002)؛ باقی D02 شامل ظرفیت خدمت، تعرفه/استثناهای ارسال و جزئیات عملیاتی روش تحویل است؛ مرجع مبلغ لجستیک و تقسیم معمول ۵۰/۵۰ طبق ADR-006 تصویب شده؛ D03 پرداخت در محل و مرجوعی؛ D04 مالیات/فاکتور؛ D05 ledger و منبع بودجه؛ D06 سیاست تخصیص سازمانی. بدون این تصمیم‌ها migration مربوط به پول و سفارش production-ready اعلام نشود.
