...
**وضعیت:** طرح پیاده‌سازی برای قواعد **مصوب** ADR-008، ADR-013 تا ADR-017 و ADR-019 تا ADR-040؛ نام جدول/مسیر/رویداد در این سند **پیشنهادی فنی** است، نه تصمیم تجاری تازه یا ادعای پیاده‌سازی موجود.  
...
**طبق [ADR-039](../adr/ADR-039-THURSDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) و [ADR-040](../adr/ADR-040-FRIDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) پنجشنبه و جمعه هر دو روز کاری عادی تسویه حنا هستند** و scheduler نباید هیچ‌یک را صرفاً به دلیل روز هفته از چرخه حذف کند. موارد قابل پیکربندی اما هنوز تصمیم‌نگرفته: تعطیلات رسمی (حتی در پنجشنبه/جمعه)، ساعت و منطقه زمانی پایان روز، برچسب‌گذاری چرخه در تعطیلات و حداقل مانده قابل پرداخت. ثبت `businessDate` و `policyVersion` امکان بازتولید محاسبات تاریخی پس از تصویب تقویم را فراهم می‌کند.
...
- وضعیت تعطیلات رسمی، منطقه زمانی و ساعت cut-off چرخه تسویه روزانه ADR-038؛ پنجشنبه طبق [ADR-039](../adr/ADR-039-THURSDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) و جمعه طبق [ADR-040](../adr/ADR-040-FRIDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) روز کاری عادی تسویه‌اند؛ کسری تسویه پس از سایر کسورات، payout انجام‌شده پیش از incident، اعتراض‌های استثنایی و سیاست اختلاف زمان تحویل.
