...
**وضعیت:** طرح پیاده‌سازی برای قواعد **مصوب** ADR-008، ADR-013 تا ADR-017 و ADR-019 تا ADR-039؛ نام جدول/مسیر/رویداد در این سند **پیشنهادی فنی** است، نه تصمیم تجاری تازه یا ادعای پیاده‌سازی موجود.  
...
**طبق [ADR-039](../adr/ADR-039-THURSDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) پنجشنبه روز کاری عادی تسویه حناست** و scheduler نباید پنجشنبه را به‌صورت پیش‌فرض از چرخه حذف کند. موارد قابل پیکربندی اما هنوز تصمیم‌نگرفته: جمعه، پنجشنبه مصادف با تعطیل رسمی و تعطیلات دیگر، ساعت و منطقه زمانی پایان روز، چگونگی برچسب‌گذاری چرخه در تعطیلات، و حداقل مانده قابل پرداخت. ثبت `businessDate` و `policyVersion` امکان بازتولید محاسبات تاریخی پس از تصویب تقویم را فراهم می‌کند.
...
- وضعیت جمعه/تعطیلات رسمی، منطقه زمانی و ساعت cut-off چرخه تسویه روزانه ADR-038؛ پنجشنبه طبق [ADR-039](../adr/ADR-039-THURSDAY-IS-HANA-SELLER-SETTLEMENT-BUSINESS-DAY.md) روز کاری عادی تسویه است؛ کسری تسویه پس از سایر کسورات، payout انجام‌شده پیش از incident، اعتراض‌های استثنایی و سیاست اختلاف زمان تحویل.
