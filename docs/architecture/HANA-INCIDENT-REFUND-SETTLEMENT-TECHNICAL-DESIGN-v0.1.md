...
**وضعیت:** طرح پیاده‌سازی برای قواعد **مصوب** ADR-008، ADR-013 تا ADR-017 و ADR-019 تا ADR-037؛ نام جدول/مسیر/رویداد در این سند **پیشنهادی فنی** است، نه تصمیم تجاری تازه یا ادعای پیاده‌سازی موجود.  
...
- مبدأ دقیق تسویه یک‌روزه ADR-008، کسری تسویه پس از سایر کسورات، payout انجام‌شده پیش از incident، اعتراض‌های استثنایی و سیاست اختلاف زمان تحویل.
