...
> **آرشیو — انتخاب فناوری بک‌اند جایگزین شده است:** این سند V0.1 یک پیشنهاد تاریخی شامل NestJS/TypeScript برای بک‌اند داشت. تصمیم اجرایی جدید طبق [ADR-045](../adr/ADR-045-HANA-TECHNOLOGY-STACK-ASPNET-CORE-DOTNET-10-LTS.md)، **ASP.NET Core / C# / .NET 10 LTS** است؛ وب Next.js و اپ خریدار React Native/Expo باقی می‌مانند. سایر محتوای این سند به‌عنوان تاریخچه حفظ شده است.
