...
| خرید/پرداخت | سبد، مقایسه، quote، سفارش، PSP، عدم موفقیت، refund؛ ممنوعیت پرداخت در محل و تست رد COD در تمام کانال‌ها؛ لغو مشتری برای سفارش ارسالی تا پیش از تحویل واقعی به پیک، شامل حالت آماده‌سازی و پیک تخصیص‌یافته، با تست race و idempotency طبق ADR-011 | قرارداد مالی و [ADR-009](../adr/ADR-009-NO-CASH-ON-DELIVERY.md) |
