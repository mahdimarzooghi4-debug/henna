...
|---|---|---|
| طراحی قرارداد/داده | ADR مصوب، ERD، OpenAPI، مدل حالت، قواعد اعتبار/فاکتور | D01–D10 |
...
از مالک محصول برای D01 مدل سفارش، D02 مقایسه/ارسال، D03 COD و refund، D04 فاکتور، D05 منابع و قواعد اعتبار، D06 الگوی سازمان، D07 تأمین‌کنندگان، D08 حقوقی، D09 شهر اول/ظرفیت و D10 مرجع UI پاسخ قابل ارجاع دریافت و در `docs/adr/` ثبت کنید. تصمیم بدون مالک و تاریخ، تصمیم قطعی محسوب نمی‌شود.
