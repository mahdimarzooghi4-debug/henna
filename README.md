...
**[Fund 001 — هسته دامنه اعتبار حمایتیِ محدود و آزمون‌های مالی پایه](docs/implementation/HANA-FUND-001.md).** صرف ثبت حساب یا مشمول، اعتبار ایجاد نمی‌کند؛ طرح/منبع تأمین/تصمیم احراز و رفرنس audit در مدل تخصیص تصریح شده‌اند. این کد هنوز به بانک، PSP، سازمان و صفحه فیگمای Fund متصل نشده و هیچ پول واقعی حرکت نمی‌دهد.
