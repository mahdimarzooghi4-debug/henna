...
[Migration("20260921220000_ImportReceipts")]
public sealed class ImportReceipts : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "import_receipts", schema: "catalog",
            columns: table => new
            {
            ...
            constraints: table =>
            {
                table.PrimaryKey("pk_catalog_import_receipts", x => x.id);
                table.CheckConstraint("ck_catalog_receipt_digest",
                    "content_sha256 ~ '^[a-f0-9]{64}$'");
                table.CheckConstraint("ck_catalog_receipt_counts",
                    "new_parents >= 0 AND changed_parents >= 0 AND " +
                    "new_children >= 0 AND changed_children >= 0");
            });
        migrationBuilder.CreateIndex(
            name: "ix_catalog_receipt_applied", schema: "catalog",
            table: "import_receipts",
            columns: ["applied_at_utc", "id"]);
        migrationBuilder.CreateIndex(
            name: "ix_catalog_receipt_digest", schema: "catalog",
